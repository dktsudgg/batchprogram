...
public class AutoconfigurationApplicationTests {
    ...
    @Value("${property.test.name}") private String propertyTestName;
    @Value("${propertyTest}") private String propertyTest;
    @Value("${noKey:default value}") private String defaultValue;
    @Value("${propertyTestList}") private String[] propertyTestArray;
    @Value("#{'${propertyTestList}'.split(',')}") private List<String> propertyTestList;
    @Value("${propertyKyoujin}") private String propertyKyoujin;
    ...
    public void testValue() {
        ...
        assertThat(propertyKyoujin, is("limkj"));
    }
